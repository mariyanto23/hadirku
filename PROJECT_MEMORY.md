...
- Admin Presensi Wajah sudah ditambahkan:
  ...
  - Area kamera Presensi Wajah memakai rasio potret pada mobile, tetap lanskap pada desktop, dan menyediakan pilihan kamera `Depan`/`Belakang` sebelum pemindaian dimulai.
