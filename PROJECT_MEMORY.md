...
- Admin Presensi Wajah sudah ditambahkan:
  ...
  - Area kamera Presensi Wajah memakai rasio potret pada mobile dan tetap lanskap pada desktop. Pada mobile, kamera memakai satu tombol ikon `balik kamera` di pojok kanan bawah area video; tombol ini bisa memilih kamera sebelum pemindaian dan mengganti stream dari kamera depan ke belakang atau sebaliknya saat kamera sudah aktif. Desktop tidak menampilkan opsi kamera karena umumnya memakai satu webcam/default browser.
