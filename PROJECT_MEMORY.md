...
- Admin Registrasi Wajah sudah direview dan diperbaiki:
  ...
  - Area kamera memakai rasio potret pada mobile dan menyediakan pilihan `Depan`/`Belakang` sebelum kamera diaktifkan. Pilihan kamera dikunci saat kamera aktif agar stream tidak berganti di tengah proses.
  - Registrasi Wajah mobile disamakan dengan Presensi Wajah: kotak video memakai empty state `Kamera belum aktif`, tombol flip kamera berada di pojok kanan bawah video, dan tombol flip baru aktif setelah kamera menyala. Kamera belakang/mobile diminta dalam rasio potret 3:4.
